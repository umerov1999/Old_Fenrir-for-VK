            ...
            new ViewDragHelper.Callback() {
                ...
                private boolean shouldDismiss(@NonNull View child, float xvel) {
                    if (xvel != 0f) {
                        ...
                        int distance = child.getLeft() - originalCapturedViewLeft;
                        int thresholdDistance = Math.round(child.getWidth() * dragDismissThreshold);
                ...
                public void onViewPositionChanged(@NonNull View child, int left, int top, int dx, int dy) {
                    ...
                    if (left <= startAlphaDistance) {
                        ...
                        float distance = fraction(startAlphaDistance, endAlphaDistance, left);
