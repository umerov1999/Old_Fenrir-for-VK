...
public class TabLayout extends HorizontalScrollView {
    ...
    private void setupWithViewPager(
            @Nullable ViewPager viewPager, boolean autoRefresh, boolean implicitSetup) {
    ...
    private void removeTabViewAt(int position) {
        TabView view = (TabView) slidingTabIndicator.getChildAt(position);
    ...
    private void setSelectedTabView(int position) {
        int tabCount = slidingTabIndicator.getChildCount();
    ...
    private int calculateScrollXForTab(int position, float positionOffset) {
        if (mode == MODE_SCROLLABLE || mode == MODE_AUTO) {
            View selectedChild = slidingTabIndicator.getChildAt(position);
            View nextChild =
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onMeasure(int origWidthMeasureSpec, int origHeightMeasureSpec) {
            ...
            if (textView != null) {
                ...
                int curLineCount = textView.getLineCount();
                int curMaxLines = TextViewCompat.getMaxLines(textView);
        ...
        private void updateTextAndIcon(
                @Nullable TextView textView, @Nullable ImageView iconView) {
            Drawable icon =
                    (tab != null && tab.getIcon() != null)
                            ? DrawableCompat.wrap(tab.getIcon()).mutate()
                            : null;
            ...
            CharSequence contentDesc = tab != null ? tab.contentDesc : null;
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if ((tabGravity == GRAVITY_CENTER) || mode == MODE_AUTO) {
                ...
                int gutter = (int) ViewUtils.dpToPx(getContext(), FIXED_WRAP_GUTTER_MIN);
                boolean remeasure = false;
        ...
        private void jumpIndicatorToSelectedPosition() {
            View currentView = getChildAt(selectedPosition);
