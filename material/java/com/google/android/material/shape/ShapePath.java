...
public class ShapePath {
    ...
    public void reset(float startX, float startY, float shadowStartAngle, float shadowSweepAngle) {
        ...
        operations.clear();
        shadowCompatOperations.clear();
        containsIncompatibleShadowOp = false;
    }
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(
            ...
            float height = operation.y - startY;
            float width = operation.x - startX;
            RectF rect = new RectF(0, 0, (float) Math.hypot(height, width), 0);
