...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    void onOffsetChanged(int offset) {
        ...
        if (listeners != null) {
            for (int i = 0, z = listeners.size(); i < z; i++) {
                BaseOnOffsetChangedListener listener = listeners.get(i);
                if (listener != null) {
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        int[] extraStates = tmpStatesArray;
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private static View getAppBarChildOnOffset(
                @NonNull AppBarLayout layout, int offset) {
        ...
        private void animateOffsetTo(
            ...
            if (velocity > 0) {
                ...
                float distanceRatio = (float) distance / child.getHeight();
        ...
        public boolean onLayoutChild(
            ...
            if (offsetToChildIndexOnLayout >= 0 && (pendingAction & PENDING_ACTION_FORCE) == 0) {
                ...
                boolean animate = (pendingAction & PENDING_ACTION_ANIMATE_ENABLED) != 0;
        ...
        boolean canDragView(T view) {
            ...
            if (lastNestedScrollingChildRef != null) {
                ...
                View scrollingView = lastNestedScrollingChildRef.get();
                return scrollingView != null
        ...
        private int interpolateOffset(@NonNull T layout, int offset) {
            ...
            for (int i = 0, z = layout.getChildCount(); i < z; i++) {
                View child = layout.getChildAt(i);
                AppBarLayout.LayoutParams childLp = (LayoutParams) child.getLayoutParams();
                Interpolator interpolator = childLp.getScrollInterpolator();
