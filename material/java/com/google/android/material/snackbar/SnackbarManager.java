...
class SnackbarManager {
    ...
    private void showNextSnackbarLocked() {
        if (nextSnackbar != null) {
            ...
            Callback callback = currentSnackbar.callback.get();
            if (callback != null) {
                callback.show();
            } else {
    ...
    private void scheduleTimeoutLocked(@NonNull SnackbarRecord r) {
        if (r.duration == BaseTransientBottomBar.LENGTH_INDEFINITE) {
        ...
        } else if (r.duration == BaseTransientBottomBar.LENGTH_SHORT) {
