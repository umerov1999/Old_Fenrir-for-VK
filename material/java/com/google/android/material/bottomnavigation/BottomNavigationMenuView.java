...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isShifting(labelVisibilityMode, visibleCount) && itemHorizontalTranslationEnabled) {
            View activeChild = getChildAt(selectedItemPosition);
            ...
            int inactiveCount = visibleCount - (activeChild.getVisibility() != View.GONE ? 1 : 0);
            int activeMaxAvailable = width - inactiveCount * inactiveItemMinWidth;
            int activeWidth =
            ...
            int inactiveWidth = Math.min(inactiveMaxAvailable, inactiveItemMaxWidth);
            ...
            int childWidth = Math.min(maxAvailable, activeItemMaxWidth);
    ...
    public void setItemTextAppearanceInactive(@StyleRes int textAppearanceRes) {
        itemTextAppearanceInactive = textAppearanceRes;
        if (buttons != null) {
            for (BottomNavigationItemView item : buttons) {
    ...
    public void setItemTextAppearanceActive(@StyleRes int textAppearanceRes) {
        itemTextAppearanceActive = textAppearanceRes;
        if (buttons != null) {
            for (BottomNavigationItemView item : buttons) {
