...
final class CircularDrawingDelegate extends DrawingDelegate<CircularProgressIndicatorSpec> {
    ...
    public void adjustCanvas(
        ...
        if ((drawable.isShowing()
                && spec.showAnimationBehavior == BaseProgressIndicator.SHOW_INWARD)
                || (drawable.isHiding()
                && spec.hideAnimationBehavior == BaseProgressIndicator.HIDE_OUTWARD)) {
            ...
            adjustedRadius += (1 - trackThicknessFraction) * spec.trackThickness / 2;
                ...
                && spec.showAnimationBehavior == BaseProgressIndicator.SHOW_OUTWARD)
                || (drawable.isHiding()
                && spec.hideAnimationBehavior == BaseProgressIndicator.HIDE_INWARD)) {
