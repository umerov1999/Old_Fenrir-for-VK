...
public class ChatBubbleActivity extends NoMainActivity implements PlaceProvider, AppStyleable {

    public static final String ACTION_OPEN_PLACE = "dev.ragnarok.fenrir.activity.ChatBubbleActivity.openPlace";
    ...
    public void openPlace(Place place) {
        ...
        switch (place.type) {
            case Place.CHAT:
                ...
                ChatFragment chatFragment = ChatFragment.Companion.newInstance(args.getInt(Extra.ACCOUNT_ID), args.getInt(Extra.OWNER_ID), peer, 0);
